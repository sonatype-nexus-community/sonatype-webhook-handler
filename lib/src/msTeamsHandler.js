...
const webhookTarget = new WebHookTarget_1.WebhookTarget(new URL(TEAMS_WEBHOOK_URL));



function processIqDataForMsTeams(payload) {
...
function getIqUrlForApplicationEvaluation(payload) {
